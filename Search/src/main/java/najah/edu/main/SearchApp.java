...
public class SearchApp {
    ...
    public String byType(String type , List<String> typelist,int count,Set<String> keys,Map<String,String> data ) {
    ...
    public String byMaterial(String material ,List<String> materiallist, int count, Set<String> keys, Map<String, String> dataTable) {
...
for(String k: keys) {
    ...
    public String byPlacement(String placement,List<String> placementlist, int count, Set<String> keys, Map<String, String> dataTable) {
    ...
    public String bypets(String pets , List<String> petslist, int count, Set<String> keys, Map<String, String> dataTable) {
...
for(String k: keys) {
	...
	arrayofk=k.split("_");
	 ...
	 public boolean bybellowarea(int area , List<String> n,int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
	 ...
	 public  boolean bybellowprice(int price , List<String> n,int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
	 ...
	 public boolean bynumbedrooms(Integer numbedroom , List<String> numofbedroomslist, int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable) {
	...
	return true;
	 ...
	 public boolean bynumbathroom(Integer numbathroom , List<String> numofbathroomslist, int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
	 ...
	 public boolean byleaseleng(int leaseleng , List<String> leaseLengthlist, int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
	 ...
	 public boolean bybetweenprice(int lp,int hp, List<String> pricelist, int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
	 ...
	 public boolean bybetweenarea(int la,int ha , List<String> arealist, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
	...
	public String byamenities(String amenities , List<String> amenitieslist, int count, Set<String> keys, Collection<String> values, Map<String, String> dataTable){
